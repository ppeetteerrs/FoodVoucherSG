...
/**
 * Generated class for the ViewCardHistoryPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-view-card-history',
  templateUrl: 'view-card-history.html',
})

export class ViewCardHistory {
  ...
  async getTransactions() {
    ...
    all_transactions = await this.db.getAll("db", "transactions", "cardID", this.card.id, -1);
